const [[query1, product_type], [query2, product]] = new URLSearchParams(
    ...
    .then((data) => {
      ...
      <div class="row">
        ...
        <div class="col-lg-6 pt-5">
          ...
          <span style="font-size: 1.5rem;">${avg_rating.toFixed(
            1,
          )}/5 (${num_of_ratings})</span>
          <ul>
      ...
      <div class="row mb-5">
        ...
        <div class="col-lg-6 px-5">
          ...
          <div class="row">
            <div class="col-lg-2 row align-content-center"><h1>${avg_rating.toFixed(
              1,
            )}</h1></div>
